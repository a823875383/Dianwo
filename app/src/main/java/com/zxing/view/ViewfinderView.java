...
public final class ViewfinderView extends View {
    ...
    Rect mRect;
    int i = 0;
    GradientDrawable mDrawable;// 采用渐变图作为扫描线
    private Drawable lineDrawable;// 采用图片作为扫描线

    private int ScreenRate;  //四个绿色边角对应的长度
    private int CORNER_WIDTH;  //四个绿色边角对应的宽度
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        lineDrawable = getResources().getDrawable(R.mipmap.qb_scan_light);
        //
        ...
        cornerColor = resources.getColor(R.color.corner_frame);
        scannerAlpha = 0;
...
//    	//①外角
//    	//左上角
//		canvas.drawRect(frame.left - 15, frame.top - 15, frame.left + 25, frame.top, paint);
//		canvas.drawRect(frame.left - 15, frame.top - 15, frame.left, frame.top + 25, paint);
//		//右上角
//		canvas.drawRect(frame.right - 25, frame.top - 15, frame.right + 15, frame.top, paint);
//		canvas.drawRect(frame.right, frame.top - 15, frame.right + 15, frame.top + 25, paint);
//		//左下角
//		canvas.drawRect(frame.left - 15, frame.bottom + 15, frame.left + 25, frame.bottom, paint);
//		canvas.drawRect(frame.left - 15, frame.bottom + 15, frame.left, frame.bottom - 25, paint);
//		//右下角
//		canvas.drawRect(frame.right - 25, frame.bottom + 15, frame.right + 15, frame.bottom, paint);
//		canvas.drawRect(frame.right, frame.bottom + 15, frame.right + 15, frame.bottom - 25, paint);
            //②内角
            // 左上角(top left corner)
...
//		textPaint.setTextSize(frame.width()/15);
//		textPaint.setColor(Color.WHITE);
//		String text = "将二维码放入框内，即可自动扫描";
//		canvas.drawText(text, middle*2/3, frame.bottom + 60, textPaint);
...
//				mRect.set(frame.left + 10, frame.top - 3 + i, frame.right - 10, frame.top + 3 + i);
//				mDrawable.setBounds(mRect);
//				mDrawable.draw(canvas);

//				mRect.set(frame.left - 6, frame.top + i - 10, frame.right + 6,
//						frame.top + 10 + i);
                    mRect.set(frame.left + 6, frame.top + i, frame.right - 6,
                            frame.top + 18 + i);
