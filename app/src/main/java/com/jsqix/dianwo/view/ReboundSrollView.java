 ...
 * 滚动回弹
 *
 * @Date: 2015-12-30 Create
 * @author: dq
 */
class ReboundSrollView extends ViewGroup {
    public final static String TAG = ReboundSrollView.class.getSimpleName();
    ...
    public ReboundSrollView(Context context) {
        this(context, null);
    }

    public ReboundSrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i(TAG, mTouchState + "====" + TOUCH_STATE_DEFALUT);
