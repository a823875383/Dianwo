...
public class ToastHelper {
    ...
    private final Runnable timerRunnable = new Runnable() {
        ...
        public void run() {
            mIsShow = false;
            removeView();
            System.out.println("3++++++show:" + mIsShow);
        }
    };
    ...
    private View getDefaultToastView() {
        ...
        view.setPadding(DensityUtil.dip2px(mContext, 10), DensityUtil.dip2px(mContext, 10), DensityUtil.dip2px(mContext, 10), DensityUtil.dip2px(mContext, 10));
    ...
    public void show() {
        System.out.println("1++++++show:"+mIsShow);
        if (!IsShow())//如果Toast没有显示，则开始加载显示
        {
            ...
            System.out.println("2++++++show:"+mIsShow);
